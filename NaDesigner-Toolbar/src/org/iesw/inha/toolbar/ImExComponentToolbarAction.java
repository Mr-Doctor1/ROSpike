...
import java.io.File;
import org.iesw.inha.main.dialog.ComponentPortStateDialog;
...
@ActionID(
        category = "NaDesigner",
        id = "org.iesw.inha.toolbar.ImExComponentToolbarAction"
)
@ActionRegistration(
        iconBase = "org/iesw/inha/toolbar/icons/icon_comp_IO24.png",
